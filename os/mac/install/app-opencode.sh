...
if command -v mise &> /dev/null; then
...
elif brew tap | grep -q "opencode-ai/tap" 2>/dev/null; then
    # Try Homebrew tap if available
    install_brew "opencode-ai/tap/opencode"
else
    ...
    LATEST_URL="https://github.com/opencode-ai/opencode/releases/latest/download/opencode-darwin-${ARCH}.tar.gz"
